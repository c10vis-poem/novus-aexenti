...
**Slug:** `npu-inference-manager` · **Role:** weight offload balancer · **Tier:** system

## What problem this solves

Balances weight offloading Alpha <-> Beta <-> Cloud. Enforces DISALLOW_NPU_OVERLAP.

## Binding

| Field | Value |
|---|---|
| Model | n/a (control plane) |
| Node | Alpha |
| Memory scope | Working-Ephemeral |
| Tool allowance | QAIRT/GenieX control, node RPC |
