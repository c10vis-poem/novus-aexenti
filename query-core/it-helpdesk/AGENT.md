...
**Slug:** `it-helpdesk` · **Role:** IT help desk + manual operator · **Tier:** query-9b

## What problem this solves

Human-facing. Walks the operator through runbooks step by step.
...
| Node | Alpha |
| Memory scope | Recall |
| Tool allowance | runbooks, device control |
